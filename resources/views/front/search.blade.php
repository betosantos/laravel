    ...
    <section id="courses" class="courses">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          <div class="container" data-aos="fade-up">
            <form class="form-inline" style="margin-bottom:10px;" method="GET" action="{{ route('front.search') }}">
            ...
            @if ($cursos->isEmpty())
              <p><b> Nehum Registro encontrado! </b></p>
            @else
              <b>Total de Registros Encontrados: {{ $cursos->count() }} </b>              
            @endif
